    ...
    <section className="foursection">
      <div className="more">
        <div className="offer">
          <div className="left">
            <img
              src="https://templatemo.com/templates/templatemo_582_tale_seo_agency/assets/images/left-infos.jpg"
              alt=""
            />
          </div>
          <div className="about">
            ...
            <p>
              ...
              Template on any other template website. Please{" "}
              <a href="">contact us</a>. Thank you.
            </p>
